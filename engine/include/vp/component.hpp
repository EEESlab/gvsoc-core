...
namespace vp
{
    ...
    class component : public component_clock, public block
    {
        ...
        friend class vp::master_port;

    public:
        component(js::config *config);
        component(vp::ComponentConf &conf);

        static vp::component *load_component(js::config *config, js::config *gv_config, vp::component *parent, std::string name, std::string path);
        ...
        void build_instance(std::string name, std::string path, vp::component *parent);
    ...
    private:
        ...
        static std::string get_component_path(js::config *gv_config, std::string relpath);
        void pre_start_all();
        void start_all();
